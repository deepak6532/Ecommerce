...
const IconCards = () => {
  ...
  {/* Card 2 */}
  <div className="flex flex-col items-center bg-white rounded-xl shadow hover:shadow-md transition p-4 w-28">
    <img src="https://cdn-icons-png.flaticon.com/512/1041/1041916.png&quot" alt='laptop'  className="w-10 h-10 mb-2 " />
    <span className="text-sm text-gray-700 text-center">Laptops</span>
  </div>
  {/* Card 3 */}
  <div className="flex flex-col items-center bg-white rounded-xl shadow hover:shadow-md transition p-4 w-28">
    <img src="https://cdn-icons-png.flaticon.com/512/1041/1041916.png&quot"  alt=' ' className="w-10 h-10 mb-2 " />
